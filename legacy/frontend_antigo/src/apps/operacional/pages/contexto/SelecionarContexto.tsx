...
import { useContextSelection } from "../../context/ContextContext";
...
export default function SelecionarContexto() {
    ...
    const { getContexto, setContexto } = useContextSelection();
    ...
    async function confirmarContexto(e: React.FormEvent) {
        e.preventDefault();
        ...
        try {
            ...
            console.error(err);
            setErro((err as Error)?.message || "Erro ao salvar contexto.");
        }
    }
    ...
    return (
        <div className="contexto-wrapper">
            <div className="contexto-logos">
                <img src="/assets/img/prefeitura.png" alt="Prefeitura" onError={(e) => (e.target as HTMLImageElement).style.display = 'none'} />
                <img src="/assets/img/sistemaalpha.png" alt="Sistema Alpha" onError={(e) => (e.target as HTMLImageElement).style.display = 'none'} />
            </div>
