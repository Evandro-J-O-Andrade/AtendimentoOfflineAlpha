...
## Declaração de Freeze Arquitetural
...
## Nenhuma linha nova de código será criada até aprovação dos documentos canônicos

### Proibições Temporárias

- ❌ Novas telas no frontend
- ❌ Novas APIs no backend
...
**Aprovação necessária por:** Engineering Manager + Software Architect