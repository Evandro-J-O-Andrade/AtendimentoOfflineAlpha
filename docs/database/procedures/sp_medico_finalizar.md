...
Objetivo: medico finalizar conforme definida no dump SQL do sistema.
...
- **Linha 16**: 'ROTINA=sp_medico_finalizar | SQLSTATE=', IFNULL(v_sqlstate,'(n/a)'),
