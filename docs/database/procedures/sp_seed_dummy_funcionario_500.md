...
Objetivo: seed dummy funcionario 500 conforme definida no dump SQL do sistema.
...
- **Linha 10**: Insere um novo registro na tabela funcionario.
- **Linha 11**: (
- **Linha 12**: nome,
- **Linha 13**: ativo,
- **Linha 14**: criado_em
...
- **Linha 16**: VALUES
- **Linha 17**: (
- **Linha 18**: CONCAT('FUNCIONARIO_SEED_', v_i),
- **Linha 19**: 1,
- **Linha 20**: NOW(6)
