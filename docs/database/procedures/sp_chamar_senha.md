...
Objetivo: chamar senha conforme definida no dump SQL do sistema.
...
- **Linha 6** (Comentario): Atualiza estado
...
- **Linha 13**: VALUES (p_id_sessao_usuario, 'senha', p_id_senha, 'CALL', NOW());
- **Linha 15** (Comentario): Evento semântico
- **Linha 16**: Insere um novo registro na tabela senha_eventos.
- **Linha 17**: VALUES (p_id_senha, p_id_sessao_usuario, 'SENHA_CHAMADA', NOW());
