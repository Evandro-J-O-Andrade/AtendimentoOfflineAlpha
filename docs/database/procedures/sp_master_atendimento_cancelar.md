...
Objetivo: master atendimento cancelar conforme definida no dump SQL do sistema.
...
- **Linha 31**: v_uuid_transacao, p_id_usuario, p_id_perfil, 'ATENDIMENTO_CANCELAR',
...
- **Linha 63**: LIMIT 1;
- **Linha 65** (Comentario): =========================
- **Linha 66** (Comentario): INSERIR STATUS CANCELADO
- **Linha 67** (Comentario): =========================
...
- **Linha 79**: v_uuid_transacao, p_id_usuario, p_id_perfil, 'ATENDIMENTO_CANCELAR',
