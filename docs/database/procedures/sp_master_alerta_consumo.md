# sp_master_alerta_consumo

Objetivo: master alerta consumo conforme definida no dump SQL do sistema.
...
- **Linha 33**: v_uuid_transacao, p_id_usuario, p_id_perfil, 'ALERTA_CONSUMO',
- **Linha 34**: NULL, v_id_alerta, p_payload, 'ERRO', v_error_msg
- **Linha 35**: );
...
- **Linha 55** (Comentario): =========================
- **Linha 56**: atribuicao de valor Ã  variavel v_tipo_alerta.
- **Linha 57**: atribuicao de valor Ã  variavel v_descricao.
...
- **Linha 62** (Comentario): =========================
- **Linha 63** (Comentario): INSERIR ALERTA
- **Linha 64** (Comentario): =========================
- **Linha 65**: Insere um novo registro na tabela alerta_consumo.
- **Linha 66**: tipo_alerta,
- **Linha 67**: descricao,
- **Linha 68**: id_unidade,
- **Linha 69**: id_funcionario,
- **Linha 70**: status,
- **Linha 71**: criado_por,
- **Linha 72**: criado_em
- **Linha 73**: ) VALUES (
- **Linha 74**: v_tipo_alerta,
- **Linha 75**: v_descricao,
- **Linha 76**: v_id_unidade,
- **Linha 77**: v_id_funcionario,
- **Linha 78**: v_status,
- **Linha 79**: p_id_usuario,
- **Linha 80**: NOW(6)
- **Linha 81**: );
- **Linha 83**: atribuicao de valor Ã  variavel v_id_alerta.
- **Linha 85** (Comentario): =========================
- **Linha 86** (Comentario): REGISTRAR LEDGER
- **Linha 87** (Comentario): =========================
- **Linha 88**: Invoca a procedure sp_ledger_evento_log.
- **Linha 89**: v_uuid_transacao, p_id_usuario, p_id_perfil, 'ALERTA_CONSUMO',
- **Linha 90**: NULL, v_id_alerta, p_payload, 'SUCESSO',
- **Linha 91**: CONCAT('Alerta registrado: ', v_tipo_alerta)
- **Linha 92**: );
- **Linha 94** (Comentario): =========================
...
- **Linha 100**: 'id_alerta', v_id_alerta,
- **Linha 101**: 'tipo_alerta', v_tipo_alerta,
- **Linha 102**: 'descricao', v_descricao,
- **Linha 103**: 'id_unidade', v_id_unidade,
- **Linha 104**: 'id_funcionario', v_id_funcionario,
