# sp_schema_add_index_if_missing

Objetivo: schema add index if missing conforme definida no dump SQL do sistema.
...
- **Linha 12**: INTO v_cnt
- **Linha 13**: FROM information_schema.STATISTICS s
- **Linha 14**: WHERE s.TABLE_SCHEMA = p_table_schema
