# sp_medicacao_finalizar

Objetivo: medicacao finalizar conforme definida no dump SQL do sistema.
...
- **Linha 16**: 'ROTINA=sp_medicacao_finalizar | SQLSTATE=', IFNULL(v_sqlstate,'(n/a)'),
