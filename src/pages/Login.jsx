...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Recepção ou Médico precisa escolher local
            ...
            // Outros perfis
            else if (perfis.includes('ADMIN') || perfis.includes('GESTAO') || perfis.includes('SUPORTE')) {
                navigate('/dashboard');
    ...
    const handleSelectLocal = (local) => {
        ...
        setAuthLocal(local); // salva local no contexto
