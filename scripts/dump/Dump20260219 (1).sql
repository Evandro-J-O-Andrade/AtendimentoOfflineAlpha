...
CREATE TABLE `codigo_universal` (
  ...
  `barcode` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `farm_dispensacao` (
  ...
  KEY `fk_farm_disp_local` (`id_estoque_local`),
  KEY `fk_farm_disp_usuario` (`id_usuario_farmacia`),
  CONSTRAINT `fk_farm_disp_ffa` FOREIGN KEY (`id_ffa`) REFERENCES `ffa` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_farm_disp_local` FOREIGN KEY (`id_estoque_local`) REFERENCES `estoque_local` (`id_estoque_local`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_farm_disp_usuario` FOREIGN KEY (`id_usuario_farmacia`) REFERENCES `usuario` (`id_usuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `farm_dispensacao_item` (
  ...
  KEY `fk_farm_item_lote` (`id_lote`),
  CONSTRAINT `fk_farm_item_disp` FOREIGN KEY (`id_dispensacao`) REFERENCES `farm_dispensacao` (`id_dispensacao`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_farm_item_lote` FOREIGN KEY (`id_lote`) REFERENCES `estoque_lote` (`id_lote`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_farm_item_prod` FOREIGN KEY (`id_produto`) REFERENCES `estoque_produto` (`id_produto`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-19  7:02:25
