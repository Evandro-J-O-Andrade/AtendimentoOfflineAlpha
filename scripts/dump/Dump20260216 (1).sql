...
CREATE TABLE `estoque_produtos` (
  ...
  `barcode_interno` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gtin_ean` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ncm` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `subcategoria` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ativo` tinyint NOT NULL DEFAULT '1',
  `controlado` tinyint NOT NULL DEFAULT '0',
  `fracionavel` tinyint NOT NULL DEFAULT '0',
  `validade_controlada` tinyint NOT NULL DEFAULT '0',
  `temperatura_armazenamento` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `observacao` text COLLATE utf8mb4_general_ci,
  `criado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_estoque_codigo_interno` (`codigo_interno`),
  UNIQUE KEY `uk_estoque_barcode_interno` (`barcode_interno`),
  UNIQUE KEY `uk_estoque_gtin` (`gtin_ean`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lab_protocolo_interno` (
  ...
  `impresso` tinyint(1) DEFAULT '0',
  `id_codigo_universal` bigint DEFAULT NULL,
  `sistema_externo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `codigo_externo` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `barcode` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `coletado_em` datetime DEFAULT NULL,
  ...
  UNIQUE KEY `uk_lab_externo` (`sistema_externo`,`codigo_externo`),
  KEY `fk_lab_protocolo_ffa_v1` (`id_ffa`),
  KEY `idx_lab_codigo_universal` (`id_codigo_universal`),
  CONSTRAINT `fk_lab_codigo_universal` FOREIGN KEY (`id_codigo_universal`) REFERENCES `codigo_universal` (`id_codigo`),
...
CREATE TABLE `procedimento_protocolo` (
  ...
  UNIQUE KEY `uk_proc_externo` (`sistema_externo`,`codigo_externo`),
  ...
  KEY `idx_proc_codigo_universal` (`id_codigo_universal`),
  CONSTRAINT `fk_proc_codigo_universal` FOREIGN KEY (`id_codigo_universal`) REFERENCES `codigo_universal` (`id_codigo`),
...
CREATE TABLE `protocolo_emissao` (
  ...
  KEY `idx_prot_codigo_universal` (`id_codigo_universal`),
  CONSTRAINT `fk_prot_codigo_universal` FOREIGN KEY (`id_codigo_universal`) REFERENCES `codigo_universal` (`id_codigo`),
...
-- Dump completed on 2026-02-16  7:51:51
