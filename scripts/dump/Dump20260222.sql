...
--
-- Table structure for table `atendimento_estado_ativo`
--

DROP TABLE IF EXISTS `atendimento_estado_ativo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `atendimento_estado_ativo` (
  `id_ffa` bigint NOT NULL,
  ...
  CONSTRAINT `fk_estado_sessao` FOREIGN KEY (`id_sessao_ultimo_movimento`) REFERENCES `sessao_usuario` (`id_sessao_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `atendimento_estado_ativo`
--

LOCK TABLES `atendimento_estado_ativo` WRITE;
...
--
-- Table structure for table `estoque_alerta`
--

DROP TABLE IF EXISTS `estoque_alerta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `estoque_alerta` (
  `id_alerta` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `estoque_alerta`
--

LOCK TABLES `estoque_alerta` WRITE;
...
CREATE TABLE `estoque_local` (
  ...
  `codigo` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tipo` enum('FARMACIA_RUA','FARMACIA_PA','FARMACIA_UPA','FARMACIA_UBS','ALMOX','LAB','OUTRO') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ala` enum('ADULTO','PEDI') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  UNIQUE KEY `uk_estoque_local_escopo` (`codigo`,`id_unidade`,`id_sistema`),
  KEY `ix_estoque_local_tipo` (`tipo`,`ativo`),
  KEY `ix_estoque_local_unidade` (`id_unidade`),
  KEY `ix_estoque_local_sistema` (`id_sistema`),
  KEY `ix_estoque_local_localop` (`id_local_operacional`),
  CONSTRAINT `fk_estoque_local_localop` FOREIGN KEY (`id_local_operacional`) REFERENCES `local_operacional` (`id_local_operacional`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_estoque_local_sistema` FOREIGN KEY (`id_sistema`) REFERENCES `sistema` (`id_sistema`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_estoque_local_unidade` FOREIGN KEY (`id_unidade`) REFERENCES `unidade` (`id_unidade`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `estoque_lote` (
  ...
  `quantidade_reservada` decimal(14,3) NOT NULL DEFAULT '0.000',
  ...
  KEY `fk_lote_codigo` (`id_codigo_universal`),
  CONSTRAINT `fk_lote_codigo` FOREIGN KEY (`id_codigo_universal`) REFERENCES `codigo_universal` (`id_codigo`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_lote_local` FOREIGN KEY (`id_estoque_local`) REFERENCES `estoque_local` (`id_estoque_local`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_lote_produto` FOREIGN KEY (`id_produto`) REFERENCES `estoque_produto` (`id_produto`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `estoque_movimento` (
  ...
  KEY `fk_mov_sessao` (`id_sessao_usuario`),
  CONSTRAINT `fk_mov_local` FOREIGN KEY (`id_estoque_local`) REFERENCES `estoque_local` (`id_estoque_local`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_mov_sessao` FOREIGN KEY (`id_sessao_usuario`) REFERENCES `sessao_usuario` (`id_sessao_usuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `estoque_movimento_item` (
  ...
  CONSTRAINT `fk_mov_item_lote` FOREIGN KEY (`id_lote`) REFERENCES `estoque_lote` (`id_lote`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_mov_item_mov` FOREIGN KEY (`id_movimento`) REFERENCES `estoque_movimento` (`id_movimento`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_mov_item_prod` FOREIGN KEY (`id_produto`) REFERENCES `estoque_produto` (`id_produto`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `estoque_produto` (
  ...
  `barcode` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `nome` varchar(255) NOT NULL,
  `descricao` text,
  ...
  `criado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizado_em` datetime DEFAULT NULL,
  `curva_abc` enum('A','B','C') DEFAULT 'C',
  `estoque_minimo` decimal(15,4) DEFAULT '0.0000',
  `estoque_maximo` decimal(15,4) DEFAULT '0.0000',
  `ponto_reposicao` decimal(15,4) DEFAULT '0.0000',
  `exige_lote` tinyint(1) DEFAULT '1',
  `controlado_anvisa` tinyint(1) DEFAULT '0',
  `registro_anvisa` varchar(50) DEFAULT NULL,
  `id_unidade_medida` binary(16) DEFAULT NULL,
...
--
-- Table structure for table `estoque_reserva`
--

DROP TABLE IF EXISTS `estoque_reserva`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `estoque_reserva` (
  ...
  `id_lote` bigint NOT NULL,
  `quantidade` decimal(14,3) NOT NULL,
  `origem_tipo` enum('FARM_DISP','PDV','AJUSTE','OUTRO') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'FARM_DISP',
  `id_documento` bigint DEFAULT NULL,
  `status` enum('ATIVA','CONFIRMADA','CANCELADA') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'ATIVA',
  `motivo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_sessao_criou` bigint NOT NULL,
  `criado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `id_sessao_finalizou` bigint DEFAULT NULL,
  `finalizado_em` datetime DEFAULT NULL,
  PRIMARY KEY (`id_reserva`),
  KEY `ix_reserva_status` (`status`,`criado_em`),
  KEY `ix_reserva_local` (`id_estoque_local`),
  KEY `ix_reserva_prod` (`id_produto`),
  KEY `ix_reserva_lote` (`id_lote`),
  KEY `ix_reserva_doc` (`origem_tipo`,`id_documento`),
  KEY `fk_reserva_sessao_criou` (`id_sessao_criou`),
  KEY `fk_reserva_sessao_finalizou` (`id_sessao_finalizou`),
  CONSTRAINT `fk_reserva_local` FOREIGN KEY (`id_estoque_local`) REFERENCES `estoque_local` (`id_estoque_local`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_reserva_lote` FOREIGN KEY (`id_lote`) REFERENCES `estoque_lote` (`id_lote`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_reserva_prod` FOREIGN KEY (`id_produto`) REFERENCES `estoque_produto` (`id_produto`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_reserva_sessao_criou` FOREIGN KEY (`id_sessao_criou`) REFERENCES `sessao_usuario` (`id_sessao_usuario`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_reserva_sessao_finalizou` FOREIGN KEY (`id_sessao_finalizou`) REFERENCES `sessao_usuario` (`id_sessao_usuario`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Reserva de estoque (pré-baixa) antes de efetivar movimento.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `estoque_reserva`
--

LOCK TABLES `estoque_reserva` WRITE;
/*!40000 ALTER TABLE `estoque_reserva` DISABLE KEYS */;
/*!40000 ALTER TABLE `estoque_reserva` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `estoque_reserva_evento`
--

DROP TABLE IF EXISTS `estoque_reserva_evento`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `estoque_reserva_evento` (
  `id_evento` bigint NOT NULL AUTO_INCREMENT,
  `id_reserva` bigint NOT NULL,
  `id_sessao_usuario` bigint NOT NULL,
  `tipo_evento` enum('CRIAR','CONFIRMAR','CANCELAR','ERRO') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `detalhe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `criado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_evento`),
  KEY `ix_res_evento_reserva` (`id_reserva`,`criado_em`),
  KEY `ix_res_evento_sessao` (`id_sessao_usuario`,`criado_em`),
  CONSTRAINT `fk_res_evento_reserva` FOREIGN KEY (`id_reserva`) REFERENCES `estoque_reserva` (`id_reserva`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_res_evento_sessao` FOREIGN KEY (`id_sessao_usuario`) REFERENCES `sessao_usuario` (`id_sessao_usuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Eventos/auditoria semântica da reserva.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `estoque_reserva_evento`
--

LOCK TABLES `estoque_reserva_evento` WRITE;
...
--
-- Table structure for table `farm_convenio_autorizacao`
--

DROP TABLE IF EXISTS `farm_convenio_autorizacao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `farm_convenio_autorizacao` (
...
--
-- Dumping data for table `farm_convenio_autorizacao`
--

LOCK TABLES `farm_convenio_autorizacao` WRITE;
...
--
-- Table structure for table `farm_operacao`
--

DROP TABLE IF EXISTS `farm_operacao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `farm_operacao` (
...
--
-- Dumping data for table `farm_operacao`
--

LOCK TABLES `farm_operacao` WRITE;
/*!40000 ALTER TABLE `farm_operacao` DISABLE KEYS */;
/*!40000 ALTER TABLE `farm_operacao` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `farm_receita_controlada`
--

DROP TABLE IF EXISTS `farm_receita_controlada`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `farm_receita_controlada` (
...
--
-- Dumping data for table `farm_receita_controlada`
--

LOCK TABLES `farm_receita_controlada` WRITE;
...
--
-- Table structure for table `operacao_idempotencia`
--

DROP TABLE IF EXISTS `operacao_idempotencia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `operacao_idempotencia` (
  `token` varchar(128) COLLATE utf8mb4_general_ci NOT NULL,
  `procedimento` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `operacao_idempotencia`
--

LOCK TABLES `operacao_idempotencia` WRITE;
...
CREATE TABLE `pdv_venda` (
  ...
  CONSTRAINT `fk_pdv_venda_sessao` FOREIGN KEY (`id_sessao_usuario`) REFERENCES `sessao_usuario` (`id_sessao_usuario`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `produto` (
  ...
  `unidade_medida` varchar(20) DEFAULT NULL,
  `controla_lote` tinyint DEFAULT '0',
  `controla_validade` tinyint DEFAULT '0',
  `controla_serial` tinyint DEFAULT '0',
  `exige_prescricao` tinyint DEFAULT '0',
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_atendimento_transicionar`(
    ...
    IN p_id_leito_destino BIGINT, -- Pode ser NULL
    IN p_novo_estado VARCHAR(50),
    IN p_justificativa TEXT
)
BEGIN
    DECLARE v_id_local_origem BIGINT;
    DECLARE v_evento_id BIGINT;

    -- [LEI 1] VALIDAÇÃO DE SESSÃO
    IF p_id_sessao_usuario IS NULL THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Sessao obrigatoria para transicao.';
    END IF;

    -- [LEI 2] BUSCA ESTADO ATUAL
    SELECT id_local_atual INTO v_id_local_origem 
    FROM atendimento_estado_ativo 
    WHERE id_ffa = p_id_ffa;

    -- [LEI 3] REGISTRA O EVENTO NO WORKFLOW (IMUTABILIDADE)
    INSERT INTO workflow_ffa_evento (
        ...
        p_id_ffa, 
        'TRANSICAO_LOCAL', 
        CONCAT('Origem: ', COALESCE(v_id_local_origem, 'INICIO'), ' -> Destino: ', p_id_local_destino, ' | ', p_justificativa),
        p_id_sessao_usuario,
        NOW()
    );
    ...
    -- [LEI 4] ATUALIZA O ESTADO ATIVO (O MOTOR)
    INSERT INTO atendimento_estado_ativo (id_ffa, id_local_atual, id_leito, tipo_estado, id_sessao_ultimo_movimento)
    VALUES (p_id_ffa, p_id_local_destino, p_id_leito_destino, p_novo_estado, p_id_sessao_usuario)
    ON DUPLICATE KEY UPDATE 
        id_local_atual = p_id_local_destino,
        id_leito = p_id_leito_destino,
        tipo_estado = p_novo_estado,
        id_sessao_ultimo_movimento = p_id_sessao_usuario;

    -- [LEI 5] SE TIVER LEITO, BLOQUEIA O LEITO (OPCIONAL/SEM TRIGGER)
    IF p_id_leito_destino IS NOT NULL THEN
        UPDATE leito SET status = 'OCUPADO' WHERE id_leito = p_id_leito_destino;
    END IF;

    -- [LEI 6] AUDITORIA OBRIGATÓRIA
    CALL sp_auditoria_evento_registrar(
        p_id_sessao_usuario,
        'FFA_TRANSICAO',
        p_id_ffa,
        'MOVER',
        CONCAT('Paciente movido para ', p_novo_estado, ' no local ', p_id_local_destino)
    );
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_farmacia_dispensar_registrar` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_farm_dispensacao_registrar` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_farm_reserva_confirmar` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
-- Dump completed on 2026-02-22 21:10:31
