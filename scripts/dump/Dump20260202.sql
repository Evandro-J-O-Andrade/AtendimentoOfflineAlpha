...
CREATE TABLE `agenda_disponibilidade` (
  ...
  `tipo` enum('ATENDIMENTO','BLOQUEIO') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `agendamentos` (
  ...
  `inicio_em` datetime NOT NULL,
  `fim_em` datetime NOT NULL,
  `status` enum('MARCADO','CHECKIN','EM_ATENDIMENTO','CONCLUIDO','CANCELADO','NAO_COMPARECEU') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'MARCADO',
  `origem` enum('RECEPCAO','TELEFONE','INTERNET','RETORNO','OUTRO') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'RECEPCAO',
...
CREATE TABLE `agendamentos_eventos` (
  ...
  `tipo` enum('CRIADO','REAGENDADO','CANCELADO','CHECKIN','INICIADO','CONCLUIDO','NAO_COMPARECEU','OBSERVACAO') COLLATE utf8mb4_general_ci NOT NULL,
  `detalhe` text COLLATE utf8mb4_general_ci,
  `de_status` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `para_status` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `criado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `servico_agendamento` (
  ...
  `tipo` enum('CONSULTA','PROCEDIMENTO','EXAME','RETORNO','OUTRO') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'CONSULTA',
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_auditoria_evento_registrar`(
  IN p_id_sessao_usuario BIGINT,
  IN p_entidade VARCHAR(64),
  IN p_id_entidade BIGINT,
  IN p_acao VARCHAR(64),
  IN p_detalhe TEXT
)
BEGIN
  DECLARE v_id_usuario BIGINT;
...
-- Dump completed on 2026-02-02 20:31:40
