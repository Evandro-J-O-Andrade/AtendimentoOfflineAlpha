...
BEGIN
    CALL sp_auditoria_evento_registrar_v2(
        p_id_sessao_usuario, p_entidade, p_id_entidade, p_acao, p_detalhe
    );
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    INSERT INTO auditoria_evento (
        ...
        p_entidade, p_id_entidade, p_acao, p_detalhe, NOW()
    );
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2026-02-01  6:39:08
