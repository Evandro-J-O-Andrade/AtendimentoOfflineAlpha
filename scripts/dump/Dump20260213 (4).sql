...
INSERT INTO `fila_senha` VALUES (1,3,'CHAMANDO','2026-02-13 06:17:42'),(2,4,'AGUARDANDO','2026-02-13 06:19:25');
...
INSERT INTO `painel_config_def` VALUES (1,'BANNER_PLANTAO_HABILITADO','BOOL',1,NULL,NULL,NULL,NULL,NULL,'TOTEM','Totem de senha: exibir banner superior com plantão.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(2,'EXIBIR_NOME_PACIENTE','BOOL',0,NULL,NULL,NULL,NULL,NULL,'PAINEL_PUBLICO','Painel público: exibir nome do paciente (padrão: NÃO).',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(3,'EXIBIR_NOME_SOCIAL','BOOL',1,NULL,NULL,NULL,NULL,NULL,'PAINEL_PUBLICO','Se exibir nome, preferir nome social quando existir.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(4,'EXIBIR_TEMPO_ESPERA','BOOL',1,NULL,NULL,NULL,NULL,NULL,'PAINEL_PUBLICO','Exibir tempo de espera no painel.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(5,'EXIBIR_TEMPO_ATENDIMENTO','BOOL',1,NULL,NULL,NULL,NULL,NULL,'PAINEL_PUBLICO','Exibir tempo em atendimento (quando aplicável).',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(6,'EXIBIR_ULTIMA_CHAMADA','BOOL',1,NULL,NULL,NULL,NULL,NULL,'PAINEL_PUBLICO','Exibir última senha chamada.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(7,'EXIBIR_NAO_COMPARECEU','BOOL',1,NULL,NULL,NULL,NULL,NULL,'PAINEL_PUBLICO','Exibir indicador/lista de não compareceu.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(8,'TTS_VOZ','TEXT',NULL,NULL,NULL,'pt-BR',NULL,NULL,'TTS','Nome/código da voz do TTS.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(9,'TTS_REPETICOES','INT',NULL,1,NULL,NULL,NULL,NULL,'TTS','Qtd de repetições por chamada.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(10,'TTS_VELOCIDADE','DECIMAL',NULL,NULL,1.0000,NULL,NULL,NULL,'TTS','Velocidade do TTS (1.00 = normal).',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(11,'PISCAR_CHAMADA','BOOL',1,NULL,NULL,NULL,NULL,NULL,'PAINEL_PUBLICO','Ativa efeito de piscada ao chamar.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(12,'PISCAR_CHAMADA_SEG','INT',NULL,8,NULL,NULL,NULL,NULL,'PAINEL_PUBLICO','Duração da piscada (segundos).',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(13,'TV_ROTATIVO_HABILITADO','BOOL',1,NULL,NULL,NULL,NULL,NULL,'TV','TV rotativo: habilitar rotação de telas.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33'),(14,'TV_ROTATIVO_INTERVALO_SEG','INT',NULL,10,NULL,NULL,NULL,NULL,'TV','Intervalo padrão de rotação (seg), se tela não definir.',NULL,1,'2026-02-13 09:23:33','2026-02-13 09:23:33');
...
CREATE TABLE `pessoa_conselho_registro` (
  ...
  `uf_registro` char(2) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `senhas` VALUES (1,1,NULL,2,1,'A','A001','2026-01-28','CLINICO','ADULTO','RECEPCAO','AGUARDANDO',0,8,NULL,NULL,NULL,NULL,NULL,NULL,'2026-01-28 06:01:27','2026-01-28 06:01:27',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL),(3,1,NULL,2,1,'A','A001','2026-02-13','CLINICO','ADULTO','TOTEM','CHAMANDO',0,NULL,NULL,1,5,5,NULL,NULL,'2026-02-13 06:17:42','2026-02-13 06:17:42','2026-02-13 06:19:40',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL),(4,1,NULL,2,2,'A','A002','2026-02-13','CLINICO','ADULTO','TOTEM','AGUARDANDO',0,NULL,NULL,1,5,NULL,NULL,NULL,'2026-02-13 06:19:25','2026-02-13 06:19:25',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL);
...
CREATE TABLE `usuario_senha_historico` (
  ...
  `motivo` enum('CRIACAO','TROCA','RESET_TI','RESET_ADMIN','MIGRACAO') COLLATE utf8mb4_general_ci NOT NULL,
...
/*!50001 CREATE VIEW `vw_painel_config_efetiva` AS SELECT 
 ...
 1 AS `valor_enum`,
 1 AS `override_em`,
 1 AS `override_id_sessao_usuario`,
 1 AS `override_id_usuario`*/;
SET character_set_client = @saved_cs_client;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_operacao_encaminhar`(
    IN p_id_sessao_usuario BIGINT,
    IN p_id_ffa BIGINT,
    IN p_tipo_destino VARCHAR(50),              -- TRIAGEM|MEDICO|RX|MEDICACAO|OBSERVACAO|...
    IN p_id_local_operacional_dst BIGINT        -- NULL -> usa local da sessão
)
main: BEGIN
    DECLARE v_id_usuario BIGINT;
    DECLARE v_id_local_dst BIGINT;

    DECLARE v_id_senha BIGINT;
    DECLARE v_id_paciente BIGINT;

    DECLARE v_prioridade TINYINT;
    DECLARE v_status_senha VARCHAR(30);
    DECLARE v_codigo VARCHAR(10);

    DECLARE v_cor VARCHAR(20);
    ...
    BEGIN
        ...
        SET @diag_msg      = v_msg;
        ROLLBACK;
        CALL sp_auditar_erro_sql(p_id_sessao_usuario, 'sp_operacao_encaminhar', 'Falha ao encaminhar');
        CALL sp_raise('ERRO_SQL', CONCAT('ROTINA=sp_operacao_encaminhar | SQLSTATE=',IFNULL(v_sqlstate,'(n/a)'),
                                         ' | ERRNO=',IFNULL(v_errno,0),
                                         ' | MSG=',IFNULL(v_msg,'(n/a)'),
                                         ' | CTX=Falha ao encaminhar'));
    END;

    CALL sp_sessao_assert(p_id_sessao_usuario);
    CALL sp_assert_true(p_id_ffa IS NOT NULL, 'PARAM', 'id_ffa é obrigatório.');
    CALL sp_assert_true(p_tipo_destino IS NOT NULL AND TRIM(p_tipo_destino) <> '', 'PARAM', 'tipo_destino é obrigatório.');

    SELECT su.id_usuario, IFNULL(p_id_local_operacional_dst, su.id_local_operacional)
      INTO v_id_usuario, v_id_local_dst
      FROM sessao_usuario su
     WHERE su.id_sessao_usuario = p_id_sessao_usuario
       AND su.ativo = 1
     LIMIT 1;

    CALL sp_assert_true(v_id_local_dst IS NOT NULL, 'PARAM', 'Local operacional destino não definido.');

    START TRANSACTION;

    -- Lock FFA
    SELECT f.id_senha, f.id_paciente, f.classificacao_cor
      INTO v_id_senha, v_id_paciente, v_cor
      FROM ffa f
     WHERE f.id_ffa = p_id_ffa
     LIMIT 1
     FOR UPDATE;

    CALL sp_assert_true(v_id_senha IS NOT NULL, 'NOT_FOUND', 'FFA não encontrada.');

    -- Lock senha e captura meta
    SELECT s.codigo, s.status, s.prioridade, s.lane
      INTO v_codigo, v_status_senha, v_prioridade, v_lane
      FROM senhas s
     WHERE s.id = v_id_senha
     LIMIT 1
     FOR UPDATE;

    CALL sp_assert_true(v_codigo IS NOT NULL, 'NOT_FOUND', 'Senha da FFA não encontrada.');

    -- Prioridade: se tiver cor (Manchester), sobrepõe
    IF v_cor IS NOT NULL AND TRIM(v_cor) <> '' THEN
        SET v_cor = UPPER(TRIM(v_cor));
        SET v_prioridade = CASE v_cor
            WHEN 'VERMELHO' THEN 5
            WHEN 'LARANJA'  THEN 4
            WHEN 'AMARELO'  THEN 3
            WHEN 'VERDE'    THEN 2
            WHEN 'AZUL'     THEN 1
            ELSE IFNULL(v_prioridade,0)
        END;
    ELSE
        SET v_prioridade = IFNULL(v_prioridade,0);
    END IF;

    -- Upsert fila_operacional ativa por FFA (evita duplicar fila)
    SET v_id_fila = NULL;
    ...
    SELECT fo.id_fila
     ...
     WHERE fo.id_ffa = p_id_ffa
       AND fo.status IN ('AGUARDANDO','CHAMANDO','EM_ATENDIMENTO','EM_EXECUCAO')
    ...
    IF v_id_fila IS NULL THEN
        INSERT INTO fila_operacional(
            id_senha, id_ffa, tipo, substatus, prioridade, status,
            id_local, id_local_operacional,
            data_entrada, chamado_em, inicio_atendimento_em, finalizado_em,
            id_usuario_operador,
            criado_em, atualizado_em
        ) VALUES (
            v_id_senha, p_id_ffa, UPPER(TRIM(p_tipo_destino)), 'NORMAL', v_prioridade, 'AGUARDANDO',
            NULL, v_id_local_dst,
            NOW(), NULL, NULL, NULL,
            v_id_usuario,
            NOW(), NOW()
    ...
    ELSE
        UPDATE fila_operacional
           SET tipo                 = UPPER(TRIM(p_tipo_destino)),
               substatus             = 'NORMAL',
               prioridade            = v_prioridade,
               status                = 'AGUARDANDO',
               id_local_operacional  = v_id_local_dst,
               data_entrada          = NOW(),
               chamado_em            = NULL,
    ...
    INSERT INTO fila_operacional_evento(
        id_fila, id_sessao_usuario, tipo_evento, detalhe, criado_em
    ) VALUES (
        v_id_fila, p_id_sessao_usuario, 'ENCAMINHAR',
        CONCAT('destino=',UPPER(TRIM(p_tipo_destino)),
               ' | local_operacional_dst=',v_id_local_dst,
               ' | lane=',IFNULL(v_lane,'(n/a)'),
               ' | cor=',IFNULL(v_cor,'(n/a)')),
        NOW()
    );

    -- Atualiza status da FFA conforme destino
    IF UPPER(TRIM(p_tipo_destino)) = 'TRIAGEM' THEN
        UPDATE ffa SET status = 'EM_TRIAGEM', atualizado_em = NOW() WHERE id_ffa = p_id_ffa;
    ELSEIF UPPER(TRIM(p_tipo_destino)) = 'MEDICACAO' THEN
        UPDATE ffa SET status = 'EM_MEDICACAO', atualizado_em = NOW() WHERE id_ffa = p_id_ffa;
    ELSEIF UPPER(TRIM(p_tipo_destino)) = 'MEDICO' THEN
        UPDATE ffa SET status = 'EM_ATENDIMENTO', atualizado_em = NOW() WHERE id_ffa = p_id_ffa;
    END IF;

    -- Status da senha (informativo)
    UPDATE senhas
       SET status = CONCAT('AGUARDANDO_', UPPER(TRIM(p_tipo_destino))),
           atualizado_em = NOW()
     WHERE id = v_id_senha;
    ...
    INSERT INTO senha_eventos(
        ...
        p_id_sessao_usuario, v_id_senha, 'ENCAMINHAR',
        CONCAT('ffa=',p_id_ffa,' | destino=',UPPER(TRIM(p_tipo_destino)),' | fila=',v_id_fila),
        v_status_senha, CONCAT('AGUARDANDO_', UPPER(TRIM(p_tipo_destino))), NOW()
    );
    ...
    CALL sp_auditoria_evento_registrar(
        ...
        v_id_fila,
        'ENCAMINHAR',
        CONCAT('senha=',v_codigo,' | ffa=',p_id_ffa,' | destino=',UPPER(TRIM(p_tipo_destino)),' | prioridade=',v_prioridade),
        NULL,
        'fila_operacional',
        NULL
    );
...
BEGIN
    ...
    CALL sp_assert_true(p_chave IS NOT NULL AND LENGTH(p_chave) > 0, 'PARAM', 'chave é obrigatória');

    -- Garante que a chave existe no dicionário
    CALL sp_assert_true(
        EXISTS(SELECT 1 FROM painel_config_def d WHERE d.chave = p_chave AND d.ativo = 1),
        'NOT_FOUND', CONCAT('Config chave inexistente/INATIVA: ', p_chave)
    );

    INSERT INTO painel_config(
        id_painel, chave,
        valor_bool, valor_int, valor_decimal, valor_text, valor_json, valor_enum,
        atualizado_em, id_usuario_alteracao
    ) VALUES (
        p_id_painel, p_chave,
        p_valor_bool, p_valor_int, p_valor_decimal, p_valor_text, p_valor_json, p_valor_enum,
        NOW(), v_id_usuario
    )
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY INVOKER */
/*!50001 VIEW `vw_painel_config_efetiva` AS select `p`.`id_painel` AS `id_painel`,`p`.`codigo` AS `codigo_painel`,`d`.`chave` AS `chave`,`d`.`tipo_valor` AS `tipo_valor`,coalesce(`o`.`valor_bool`,`d`.`default_bool`) AS `valor_bool`,coalesce(`o`.`valor_int`,`d`.`default_int`) AS `valor_int`,coalesce(`o`.`valor_decimal`,`d`.`default_decimal`) AS `valor_decimal`,coalesce(`o`.`valor_text`,`d`.`default_text`) AS `valor_text`,coalesce(`o`.`valor_json`,`d`.`default_json`) AS `valor_json`,coalesce(`o`.`valor_enum`,`d`.`default_enum`) AS `valor_enum`,`o`.`atualizado_em` AS `override_em`,`o`.`id_sessao_usuario` AS `override_id_sessao_usuario`,`o`.`id_usuario` AS `override_id_usuario` from ((`painel` `p` join `painel_config_def` `d` on((`d`.`ativo` = 1))) left join `painel_config` `o` on(((`o`.`id_painel` = `p`.`id_painel`) and (`o`.`chave` = `d`.`chave`)))) where (`p`.`ativo` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY INVOKER */
/*!50001 VIEW `vw_painel_config_json` AS select `v`.`id_painel` AS `id_painel`,`v`.`codigo_painel` AS `codigo_painel`,json_objectagg(`v`.`chave`,(case `v`.`tipo_valor` when 'BOOL' then ifnull(`v`.`valor_bool`,0) when 'INT' then ifnull(`v`.`valor_int`,0) when 'DECIMAL' then ifnull(`v`.`valor_decimal`,0.0) when 'TEXT' then ifnull(`v`.`valor_text`,'') when 'ENUM' then ifnull(`v`.`valor_enum`,'') when 'JSON' then ifnull(`v`.`valor_json`,json_object()) else NULL end)) AS `config_json` from `vw_painel_config_efetiva` `v` group by `v`.`id_painel`,`v`.`codigo_painel` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-02-13  7:07:00
