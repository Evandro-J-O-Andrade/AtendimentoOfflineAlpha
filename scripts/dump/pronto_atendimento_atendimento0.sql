...
CREATE TABLE `atendimento` (
  ...
  KEY `fk_atendimento_senha` (`id_senha`),
  ...
  CONSTRAINT `fk_atendimento_senha` FOREIGN KEY (`id_senha`) REFERENCES `senhas` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2026-01-25 23:10:23
