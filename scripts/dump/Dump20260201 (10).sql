...
CREATE TABLE `agendamentos` (
  ...
  CONSTRAINT `agendamentos_ibfk_4` FOREIGN KEY (`id_senha`) REFERENCES `senhas` (`id`) ON DELETE SET NULL
...
CREATE TABLE `almoxarifado_central` (
  ...
  `nfe_chave_acesso` varchar(44) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `assinatura_digital_documentos` (
  ...
  `tipo_documento` enum('EVOLUCAO','RECEITA','LAUDO','ALTA') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `hash_assinatura` text COLLATE utf8mb4_general_ci NOT NULL,
  `certificado_serial` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `atendimento_balanco_hidrico` (
  ...
  `tipo_movimentacao` enum('ENTRADA','SAIDA') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `atendimento_checagem` (
  ...
  `status` enum('PENDENTE','REALIZADO','RECUSADO','ATRASADO') COLLATE utf8mb4_general_ci DEFAULT 'PENDENTE',
  `motivo_recusa` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `atendimento_desfecho` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_atendimento` bigint NOT NULL,
  `tipo_desfecho` enum('ALTA_MEDICA','ALTA_A_PEDIDO','TRANSFERENCIA','OBITO','EVASAO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_usuario_alta` bigint NOT NULL,
  `sumario_alta` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `atendimento_diagnosticos` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_atendimento` bigint NOT NULL,
  `codigo_cid` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descricao` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipo` enum('PRINCIPAL','SECUNDARIO','HIPOTESE') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `atendimento_escalas_risco` (
  ...
  `id_atendimento` bigint NOT NULL,
  `id_usuario` bigint NOT NULL,
  `escala_tipo` enum('MORSE_QUEDA','BRADEN_LESÃO_PELE','GLASGOW') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pontuacao_total` int NOT NULL,
  `classificacao_resultado` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `atendimento_evolucao` (
  ...
  `id_atendimento` bigint NOT NULL,
  `id_usuario` bigint NOT NULL,
  `tipo_profissional` enum('MEDICO','ENFERMEIRO','TECNICO','OUTROS') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `texto_evolucao` text COLLATE utf8mb4_general_ci NOT NULL,
  `hash_seguranca` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `criado_em` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `atendimento_sumario_alta` (
  ...
  `motivo_internacao` text COLLATE utf8mb4_general_ci,
  `resumo_clinico` text COLLATE utf8mb4_general_ci,
  `procedimentos_realizados` text COLLATE utf8mb4_general_ci,
  `orientacoes_pos_alta` text COLLATE utf8mb4_general_ci,
  `medicamentos_receitados` text COLLATE utf8mb4_general_ci,
  `data_alta` datetime DEFAULT CURRENT_TIMESTAMP,
  `assinatura_hash` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `auditoria_visualizacao_prontuario` (
  ...
  `id_usuario` bigint NOT NULL,
  `id_atendimento` bigint NOT NULL,
  `ip_acesso` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `data_hora` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `chamada_painel` (
  ...
  `status` enum('CHAMANDO','ATENDIDO','NAO_COMPARECEU') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'CHAMANDO',
  `data_hora` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `config_leitos` (
  ...
  `tipo` enum('OBSERVACAO','EMERGENCIA','INTERNACAO','ISOLAMENTO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_ocupacao` enum('LIVRE','OCUPADO','RESERVADO','HIGIENIZACAO','MANUTENCAO') COLLATE utf8mb4_general_ci DEFAULT 'LIVRE',
...
CREATE TABLE `config_locais` (
  ...
  `tipo` enum('RECEPCAO','TRIAGEM','CONSULTORIO','EXAME','MEDICACAO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ativo` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `config_sistema_alpha` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_unidade` bigint NOT NULL,
  `parametro` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `enfermagem_aprazamento` (
  ...
  `status` enum('AGUARDANDO','REALIZADO','ATRASADO','SUSPENSO') COLLATE utf8mb4_general_ci DEFAULT 'AGUARDANDO',
  `observacao` text COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `enfermagem_diagnosticos` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_ffa` bigint NOT NULL,
  `diagnostico_selecionado` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipo` enum('HISTORICO','EXAME_FISICO','DIAGNOSTICO','PRESCRICAO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `observacao` text COLLATE utf8mb4_general_ci,
  `id_usuario` bigint NOT NULL,
  `data_hora` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `escala_medica` (
  ...
  `turno` enum('MANHA','TARDE','NOITE','24H') COLLATE utf8mb4_general_ci NOT NULL,
  `status_presenca` enum('PREVISTO','CONFIRMADO','FALTOU','SUBSTITUIDO') COLLATE utf8mb4_general_ci DEFAULT 'PREVISTO',
...
CREATE TABLE `escala_plantao_atual` (
  ...
  `registro_profissional` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `data_inicio` datetime DEFAULT NULL,
  `data_fim` datetime DEFAULT NULL,
  `status_plantao` enum('ATIVO','ENCERRADO') COLLATE utf8mb4_general_ci DEFAULT 'ATIVO',
  PRIMARY KEY (`id`),
...
CREATE TABLE `estoque_almoxarifado_central` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_produto` int NOT NULL,
  `lote` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `validade` date NOT NULL,
  `quantidade_atual` decimal(12,4) NOT NULL,
  `valor_unitario_compra` decimal(12,4) DEFAULT NULL,
  `id_fornecedor` int DEFAULT NULL,
  `nota_fiscal` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `estoque_produtos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `codigo_ean` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `farmacia_venda` (
  ...
  `cliente_nome` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cliente_cpf` varchar(14) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `valor_bruto` decimal(12,2) DEFAULT '0.00',
  `valor_desconto` decimal(12,2) DEFAULT '0.00',
  `valor_liquido` decimal(12,2) DEFAULT '0.00',
  `forma_pagamento` enum('DINHEIRO','CARTAO_DEBITO','CARTAO_CREDITO','PIX') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_venda` enum('ABERTA','FINALIZADA','CANCELADA') COLLATE utf8mb4_general_ci DEFAULT 'FINALIZADA',
...
CREATE TABLE `faturamento_conta_paciente` (
  ...
  `status_conta` enum('ABERTA','FECHADA','FATURADA','PAGA','GLOSADA') COLLATE utf8mb4_general_ci DEFAULT 'ABERTA',
  `valor_total` decimal(12,2) DEFAULT '0.00',
  `numero_guia_principal` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `data_fechamento` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `faturamento_convenio` (
  ...
  `id_atendimento` bigint NOT NULL,
  `id_convenio` int NOT NULL,
  `numero_guia` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `valor_total` decimal(12,2) DEFAULT NULL,
  `status_guia` enum('ABERTA','ENVIADA','PAGA','GLOSADA') COLLATE utf8mb4_general_ci DEFAULT 'ABERTA',
  `xml_gerado` longtext COLLATE utf8mb4_general_ci,
...
CREATE TABLE `faturamento_convenios` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome_fantasia` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `registro_ans` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `faturamento_producao` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_atendimento` bigint NOT NULL,
  `codigo_procedimento` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cbo_profissional` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_faturamento` enum('PENDENTE','PROCESSADO','GLOSADO') COLLATE utf8mb4_general_ci DEFAULT 'PENDENTE',
  `criado_em` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `faturamento_sigtap` (
  `id` int NOT NULL AUTO_INCREMENT,
  `codigo_procedimento` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `nome_procedimento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `valor_sh` decimal(10,2) DEFAULT NULL,
  `valor_sa` decimal(10,2) DEFAULT NULL,
  `complexidade` enum('BASICA','MEDIA','ALTA') COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `faturamento_sus_config` (
  ...
  `cnes_unidade` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gestao_municipal_estadual` enum('M','E') COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ffa_demandas_externas` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_atendimento` bigint NOT NULL,
  `tipo_demanda` enum('RX_EXTERNO','MEDICACAO_EXTERNA','EXAME_EXTERNO','OUTROS') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descricao` text COLLATE utf8mb4_general_ci,
  `profissional_externo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` enum('PENDENTE','REALIZADO','CANCELADO') COLLATE utf8mb4_general_ci DEFAULT 'PENDENTE',
  `criado_em` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `ffa_extra` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_atendimento` bigint DEFAULT NULL,
  `tipo_extra` enum('MEDICACAO_EXTERNA','RX_EXTERNO','EXAME_EXTERNO','PROCEDIMENTO_AVULSO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descricao` text COLLATE utf8mb4_general_ci,
  `status` varchar(45) COLLATE utf8mb4_general_ci DEFAULT 'PENDENTE',
  `criado_em` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ffa_historico_status` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_ffa` bigint NOT NULL,
  `status_anterior` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_novo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `fila_senha` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_senha` bigint NOT NULL,
  `status` varchar(50) COLLATE utf8mb4_general_ci DEFAULT 'AGUARDANDO',
  `criado_em` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `financeiro_repasse_medico` (
  ...
  `status_pagamento` enum('PREVIA','APROVADO','PAGO','GLOSADO') COLLATE utf8mb4_general_ci DEFAULT 'PREVIA',
...
CREATE TABLE `hospital_leitos` (
  ...
  `id_unidade` int NOT NULL,
  `nome_leito` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `tipo_leito` enum('OBSERVACAO','EMERGENCIA','INTERNACAO','ISOLAMENTO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` enum('LIVRE','OCUPADO','RESERVADO','LIMPEZA','MANUTENCAO') COLLATE utf8mb4_general_ci DEFAULT 'LIVRE',
  `id_atendimento_atual` bigint DEFAULT NULL,
...
CREATE TABLE `internacao` (
  ...
  `precaucao` enum('PADRAO','CONTATO','GOTICULAS','AEROSSOIS') COLLATE utf8mb4_general_ci DEFAULT 'PADRAO',
...
CREATE TABLE `internacao_dietas` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_prescricao_item` bigint NOT NULL,
  `consistencia` enum('LIVRE','BRANDAS','PASTOSA','LIQUIDA','ZERO','ENTERAL','PARENTERAL') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `restricao` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `lab_pedido_alpha` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_ffa` bigint DEFAULT NULL,
  `protocolo_interno` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `codigo_barras` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` enum('CRIADO','COLETADO','ENVIADO','CONCLUIDO') COLLATE utf8mb4_general_ci DEFAULT 'CRIADO',
  `criado_em` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `leito` (
  ...
  `status` enum('DISPONIVEL','OCUPADO','RESERVADO','LIMPEZA','MANUTENCAO','INTERDITADO') COLLATE utf8mb4_general_ci DEFAULT 'DISPONIVEL',
  PRIMARY KEY (`id_leito`),
...
CREATE TABLE `log_acesso_prontuario` (
  ...
  `id_usuario` bigint NOT NULL,
  `id_atendimento` bigint NOT NULL,
  `ip_maquina` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `data_hora_acesso` datetime DEFAULT CURRENT_TIMESTAMP,
  `modulo_acessado` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `log_leitura_prontuario` (
  ...
  `id_usuario` bigint NOT NULL,
  `data_hora` datetime DEFAULT CURRENT_TIMESTAMP,
  `motivo_acesso` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notificacao_epidemiologica` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_atendimento` bigint NOT NULL,
  `cid_10` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `doenca_suspeita` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_notificacao` enum('PENDENTE','ENVIADO_MS','ARQUIVADO') COLLATE utf8mb4_general_ci DEFAULT 'PENDENTE',
  `data_evento` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paciente_alertas` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_pessoa` bigint NOT NULL,
  `tipo_alerta` enum('ALERGIA','COMORBIDADE','RISCO_INFECCAO','PRECAUCAO_CONTATO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descricao` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `grau_severidade` enum('BAIXO','MODERADO','ALTO','CRITICO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `data_registro` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `painel_alertas_tempo` (
  ...
  `nivel` enum('AVISO','CRITICO') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `pep_assinatura_digital` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_atendimento` bigint NOT NULL,
  `hash_conteudo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `assinatura_base64` text COLLATE utf8mb4_general_ci,
  `data_assinatura` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `pessoa_alergias` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_pessoa` bigint NOT NULL,
  `substancia` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `gravidade` enum('LEVE','MODERADA','GRAVE/CHOQUE') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `prescricao_kit_master` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome_kit` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `descricao` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ativo` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `qualidade_eventos_adversos` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_atendimento` bigint NOT NULL,
  `tipo_evento` enum('QUEDA','ERRO_MEDICACAO','INFECCAO_SITIO','LESÃO_PRESSAO','OUTROS') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gravidade` enum('LEVE','MODERADA','GRAVE','SENTINELA') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descricao` text COLLATE utf8mb4_general_ci,
  `data_evento` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `senhas` VALUES (1,1,NULL,2,1,'A','A001','2026-01-28','CLINICO','ADULTO','RECEPCAO','AGUARDANDO',0,8,NULL,NULL,NULL,NULL,'2026-01-28 06:01:27',NULL,NULL,NULL);
...
CREATE TABLE `sessao_ativa` (
  `id_usuario` bigint NOT NULL,
  `token_sessao` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `sessao_operacional` (
  ...
  `id_local` int NOT NULL,
  `ip_maquina` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `token_sessao` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `setor` (
  ...
  `id_unidade` bigint NOT NULL,
  `nome` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `tipo` enum('PRONTO_SOCORRO','OBSERVACAO','INTERNACAO','UTI_ADULTO','UTI_PEDIATRICA','CENTRO_CIRURGICO') COLLATE utf8mb4_general_ci NOT NULL,
  `ramal` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tabela_tuss` (
  `codigo_tuss` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `transporte_ambulancia` (
  ...
  `condutor_nome` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipo_equipe` enum('BASICA','AVANCADA','AEREA') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `usuario_sistema_perfil` (
  ...
  `perfil_slug` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
BEGIN
  ...
  (id_sessao_usuario, id_usuario, id_usuario_espelho, entidade, id_entidade, acao, detalhe, criado_em)
  VALUES
  (p_id_sessao_usuario, v_id_usuario, v_id_usuario, p_entidade, p_id_entidade, p_acao, p_detalhe, NOW());
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
  -- Compat temporária: delega 100% para a canônica
  CALL sp_auditoria_evento_registrar(p_id_sessao_usuario, p_entidade, p_id_entidade, p_acao, p_detalhe);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    IF v_status_old NOT IN ('GERADA','AGUARDANDO','NAO_COMPARECEU') THEN
...
BEGIN
    ...
    SET v_prefixo =
        CASE
            ...
            WHEN p_tipo_atendimento IN ('PRIORITARIO','EMERGENCIA') OR p_prioridade > 0 THEN 'P'
    ...
    SET v_lane =
        CASE
            ...
            WHEN p_tipo_atendimento IN ('PRIORITARIO','EMERGENCIA') OR p_prioridade > 0 THEN 'PRIORITARIO'
            ELSE 'ADULTO'
        END;
    ...
    -- Evento de geração (mantendo schema simples)
    INSERT INTO senha_eventos (id_senha, id_sessao_usuario, status_anterior, status_novo, criado_em)
    VALUES (v_id_senha, p_id_sessao_usuario, 'NOVA', 'GERADA', NOW());

    -- Auditoria por sessão (código + detalhe)
    CALL sp_auditoria_evento_registrar(
        p_id_sessao_usuario,
        'senhas', v_id_senha, 'GERAR',
        CONCAT('Senha gerada: ', v_codigo, ' (tipo=', p_tipo_atendimento, ', lane=', v_lane, ', origem=', p_origem, ', prioridade=', COALESCE(p_prioridade,0), ')')
    );
...
BEGIN
    ...
    IF v_id_usuario IS NULL OR v_id_sistema IS NULL OR v_id_unidade IS NULL OR v_id_local IS NULL THEN
        SET v_msg = 'Sessão inválida/inativa ou sem contexto completo';
    ...
    IF v_status_old IS NULL THEN
        SET v_msg = 'Senha não encontrada';
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = v_msg;
    END IF;

    IF v_id_sistema_senha <> v_id_sistema OR v_id_unidade_senha <> v_id_unidade THEN
        SET v_msg = 'Senha não pertence ao sistema/unidade da sessão';
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = v_msg;
    END IF;

    IF v_id_local_senha <> v_id_local THEN
        SET v_msg = 'Senha não pertence ao local operacional da sessão (fila do setor)';
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = v_msg;
    END IF;

    IF v_status_old <> 'CHAMANDO' THEN
        SET v_msg = CONCAT('Complementação só pode iniciar quando status=CHAMANDO. Atual: ', v_status_old);
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = v_msg;
    END IF;
    ...
    INSERT INTO senha_eventos (id_senha, id_sessao_usuario, status_anterior, status_novo, criado_em)
    VALUES (p_id_senha, p_id_sessao_usuario, v_status_old, 'EM_COMPLEMENTACAO', NOW());

    INSERT INTO auditoria_evento (
        id_sessao_usuario, id_usuario, id_usuario_espelho,
        entidade, id_entidade, acao, detalhe, criado_em
    ) VALUES (
        p_id_sessao_usuario, v_id_usuario, v_id_usuario,
        'senhas', p_id_senha, 'INICIAR_COMPLEMENTACAO',
        CONCAT('Início de complementação. status ', v_status_old, ' -> EM_COMPLEMENTACAO (local=', v_id_local, ')'),
        NOW()
    );

    COMMIT;

    SELECT p_id_senha AS id, 'EM_COMPLEMENTACAO' AS status;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_recepcao_salvar_complementacao`(
  ...
  -- flags da recepção
  IN p_tipo_atendimento ENUM('CLINICO','PEDIATRICO','PRIORITARIO','EXAME'),
  IN p_prioridade TINYINT,
  IN p_observacao TEXT
)
BEGIN
  ...
  DECLARE v_tipo_local ENUM('RECEPCAO','TRIAGEM','MEDICO_CLINICO','MEDICO_PED','RX','MEDICACAO','EXAMES','INTERNACAO','OUTRO');

  DECLARE v_status_old VARCHAR(40);
  DECLARE v_codigo     VARCHAR(10);
  DECLARE v_local_senha BIGINT;
  DECLARE v_id_paciente_senha BIGINT;
  DECLARE v_id_ffa_senha BIGINT;

  DECLARE v_id_pessoa BIGINT;
  DECLARE v_id_paciente BIGINT;
  DECLARE v_id_ffa BIGINT;
  DECLARE v_gpat VARCHAR(20);
  ...
  BEGIN
    ...
    -- Loga no trilho de auditoria (sem depender de triggers)
    CALL sp_auditar_erro_sql(
      p_id_sessao_usuario,
      'senhas',
      p_id_senha,
      'SP_RECEPCAO_COMPLEMENTACAO_FAIL',
      v_sqlstate,
      v_errno,
      v_errmsg
    );

    -- Erro padrão pro frontend
    CALL sp_raise('ERRO_SQL', 'sp_recepcao_salvar_complementacao');
  END;

  START TRANSACTION;

  -- (1) Sessão válida e ativa (fonte da verdade)
  SELECT id_usuario, id_sistema, id_unidade, id_local_operacional
    INTO v_id_usuario, v_id_sistema, v_id_unidade, v_id_local
    FROM sessao_usuario
   WHERE id_sessao_usuario = p_id_sessao_usuario
  ...
  -- (2) Só recepção pode complementar
  SELECT tipo
    INTO v_tipo_local
    FROM local_operacional
   WHERE id_local_operacional = v_id_local
     AND ativo = 1
   LIMIT 1;

  IF v_tipo_local IS NULL THEN
    CALL sp_raise('ERRO_SESSAO_LOCAL_INVALIDO', NULL);
  END IF;

  IF v_tipo_local <> 'RECEPCAO' THEN
    -- reusa catálogo existente, detalhe deixa claro o motivo
    CALL sp_raise('ERRO_SESSAO_LOCAL_INVALIDO', 'APENAS_RECEPCAO');
  END IF;

  -- (3) Trava a senha (concorrência) e valida contexto
  SELECT status, codigo, id_local_operacional, id_paciente, id_ffa
    INTO v_status_old, v_codigo, v_local_senha, v_id_paciente_senha, v_id_ffa_senha
    FROM senhas
   WHERE id = p_id_senha
     AND id_sistema = v_id_sistema
     AND id_unidade = v_id_unidade
  ...
  IF v_local_senha IS NOT NULL AND v_local_senha <> v_id_local THEN
    CALL sp_raise('ERRO_SENHA_FORA_LOCAL', NULL);
  END IF;

  IF v_status_old <> 'EM_COMPLEMENTACAO' THEN
    CALL sp_raise('ERRO_SENHA_STATUS_INVALIDO', v_status_old);
  END IF;

  IF v_id_ffa_senha IS NOT NULL THEN
    CALL sp_raise('ERRO_SENHA_STATUS_INVALIDO', 'JA_COMPLEMENTADA');
  END IF;

  -- (4) Pessoa: casa por CPF (prioritário) e depois CNS
  ...
  IF v_id_pessoa IS NULL AND p_cns IS NOT NULL AND p_cns <> '' THEN
    SELECT id_pessoa INTO v_id_pessoa
      FROM pessoa
     WHERE cns = p_cns
     LIMIT 1;
  ...
  IF v_id_pessoa IS NULL THEN
    INSERT INTO pessoa (
      nome_completo, nome_social, cpf, cns, data_nascimento, sexo, nome_mae
    )
    VALUES (
      NULLIF(p_nome_completo,''), NULLIF(p_nome_social,''), NULLIF(p_cpf,''), NULLIF(p_cns,''),
      p_dt_nascimento,
      CASE WHEN p_sexo IN ('M','F','O') THEN p_sexo ELSE NULL END,
      NULLIF(p_nome_mae,'')
    );
  ...
  ELSE
    UPDATE pessoa
       SET nome_completo = COALESCE(NULLIF(p_nome_completo,''), nome_completo),
           ...
           data_nascimento = COALESCE(p_dt_nascimento, data_nascimento),
           sexo = COALESCE(CASE WHEN p_sexo IN ('M','F','O') THEN p_sexo ELSE NULL END, sexo),
           nome_mae = COALESCE(NULLIF(p_nome_mae,''), nome_mae),
           cpf = CASE
                   WHEN (cpf IS NULL OR cpf = '') AND p_cpf IS NOT NULL AND p_cpf <> '' THEN p_cpf
                   ELSE cpf
                 END,
           cns = CASE
                   WHEN (cns IS NULL OR cns = '') AND p_cns IS NOT NULL AND p_cns <> '' THEN p_cns
                   ELSE cns
                 END
     WHERE id_pessoa = v_id_pessoa;
  END IF;

  -- (5) Paciente: 1:1 com pessoa
  SELECT id
    INTO v_id_paciente
    FROM paciente
   WHERE id_pessoa = v_id_pessoa
  ...
  IF v_id_paciente IS NULL THEN
    INSERT INTO paciente (id_pessoa, prontuario, data_cadastro)
    VALUES (v_id_pessoa, CONCAT('PR', LPAD(v_id_pessoa, 8, '0')), NOW());
    SET v_id_paciente = LAST_INSERT_ID();
  END IF;

  -- (6) Abre FFA (canônico: uma FFA por senha)
  -- FFA.tipo_atendimento não tem PRIORITARIO: mapeia pra CLINICO (prioridade continua separada)
  SET v_gpat = CONCAT('GP', DATE_FORMAT(NOW(), '%y%m%d'), '-', v_codigo);
  ...
  VALUES (
    ...
    CASE
      WHEN p_tipo_atendimento = 'PEDIATRICO' THEN 'PEDIATRICO'
      WHEN p_tipo_atendimento = 'EXAME' THEN 'EXAME'
      ELSE 'CLINICO'
    END,
    p_observacao
  );
  ...
  -- (7) Vínculo final na senha (sem mudar status: continua EM_COMPLEMENTACAO até o operador encaminhar)
  UPDATE senhas
  ...
  -- (8) Auditoria obrigatória por sessão
  CALL sp_auditoria_evento_registrar(
    p_id_sessao_usuario,
    'senhas',
    p_id_senha,
    'COMPLEMENTAR_RECEPCAO',
    CONCAT(
      'Pessoa=', v_id_pessoa,
      ' Paciente=', v_id_paciente,
      ' FFA=', v_id_ffa,
      ' GPAT=', v_gpat,
      ' tipo=', p_tipo_atendimento,
      ' prioridade=', COALESCE(p_prioridade,0)
  ...
  CALL sp_auditoria_evento_registrar(
    ...
    v_id_ffa,
    'ABRIR_POR_SENHA',
    CONCAT('Abertura de FFA por complementação. Senha=', p_id_senha, ' Paciente=', v_id_paciente)
  );

  COMMIT;

  -- payload pro frontend
  SELECT
    ...
    v_id_ffa     AS id_ffa,
    v_gpat       AS gpat,
    'EM_COMPLEMENTACAO' AS status_senha;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    BEGIN
        ...
        CALL sp_raise('ERRO_SQL', 'sp_senha_iniciar_complementacao');
    END;
    ...
    CALL sp_auditoria_evento_registrar(
        p_id_sessao_usuario,
        'senhas', p_id_senha, 'INICIAR_COMPLEMENTACAO',
        CONCAT('status ', v_status_old, ' -> EM_COMPLEMENTACAO')
    );
...
BEGIN
    ...
    BEGIN
        ROLLBACK;
        CALL sp_auditar_erro_sql(p_id_sessao_usuario, 'sp_senha_nao_compareceu', v_id_usuario);
        CALL sp_raise('ERRO_SQL', 'sp_senha_nao_compareceu');
    END;
    ...
    INSERT INTO senha_eventos (id_senha, id_sessao_usuario, status_anterior, status_novo, criado_em)
    VALUES (p_id_senha, p_id_sessao_usuario, v_status_old, 'NAO_COMPARECEU', NOW());

    CALL sp_auditoria_evento_registrar(
        p_id_sessao_usuario,
        'senhas', p_id_senha, 'NAO_COMPARECEU',
        'Chamada não atendida (manual)'
    );

    COMMIT;

    SELECT p_id_senha AS id, 'NAO_COMPARECEU' AS status;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
  DECLARE v_id_sessao BIGINT DEFAULT NULL;
  ...
  BEGIN
    ...
    ROLLBACK;
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERRO_SESSAO_ABRIR_INTERNO';
  END;

  START TRANSACTION;

  IF p_id_usuario IS NULL OR p_id_sistema IS NULL OR p_id_unidade IS NULL OR p_id_local_operacional IS NULL THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERRO_SESSAO_CONTEXTO_INCOMPLETO';
  END IF;
  ...
  SELECT COUNT(*) INTO v_existe
   ...
   WHERE id_usuario = p_id_usuario
     AND ativo = 1;
  IF v_existe = 0 THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERRO_SESSAO_USUARIO_INVALIDO';
  END IF;
  ...
  SELECT COUNT(*) INTO v_existe
   ...
   WHERE id_sistema = p_id_sistema
     AND ativo = 1;
  IF v_existe = 0 THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERRO_SESSAO_SISTEMA_INVALIDO';
  END IF;

  -- Unidade válida e pertencente ao sistema
  SELECT COUNT(*) INTO v_existe
    FROM unidade
  ...
  IF v_existe = 0 THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERRO_SESSAO_UNIDADE_INVALIDA';
  END IF;

  -- Local operacional válido e pertencente ao sistema/unidade
  SELECT COUNT(*) INTO v_existe
    FROM local_operacional
   WHERE id_local_operacional = p_id_local_operacional
     AND ativo = 1
     AND id_unidade = p_id_unidade
     AND id_sistema = p_id_sistema;
  IF v_existe = 0 THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERRO_SESSAO_LOCAL_INVALIDO';
  END IF;

  -- Encerra qualquer sessão ativa do usuário (1 usuário = 1 sessão ativa)
  UPDATE sessao_usuario
     SET ativo = 0,
         fim_sessao = COALESCE(fim_sessao, NOW())
   WHERE id_usuario = p_id_usuario
     AND ativo = 1;
  ...
  INSERT INTO sessao_usuario
    (id_usuario, id_unidade, id_sistema, id_local_operacional, token, ip_acesso, user_agent, inicio_sessao, ativo)
  VALUES
    (p_id_usuario, p_id_unidade, p_id_sistema, p_id_local_operacional, v_token, p_ip_acesso, p_user_agent, NOW(), 1);

  SET v_id_sessao = LAST_INSERT_ID();

  INSERT INTO auditoria_evento
    (id_sessao_usuario, entidade, id_entidade, acao, detalhe, criado_em, id_usuario, id_usuario_espelho)
  VALUES
    (v_id_sessao, 'sessao_usuario', v_id_sessao, 'ABRIR',
     CONCAT('Sessão aberta. sistema=',p_id_sistema,' unidade=',p_id_unidade,' local=',p_id_local_operacional),
     NOW(), p_id_usuario, p_id_usuario);

  COMMIT;

  SELECT 1 AS ok,
         'OK' AS code,
         'Sessão aberta' AS message,
...
BEGIN
  ...
  BEGIN
    ...
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERRO_SESSAO_ENCERRAR_INTERNO';
  END;
  ...
  IF v_id_usuario IS NULL THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ERRO_SESSAO_NAO_ENCONTRADA';
  END IF;
  ...
  INSERT INTO auditoria_evento
    (id_sessao_usuario, id_usuario, id_usuario_espelho, entidade, id_entidade, acao, detalhe, criado_em)
  VALUES
    (p_id_sessao_usuario, v_id_usuario, v_id_usuario, 'sessao_usuario', p_id_sessao_usuario, 'ENCERRAR',
     CONCAT('Sessão encerrada. id_sessao_usuario=',p_id_sessao_usuario),
     NOW());

  COMMIT;

  SELECT 1 AS ok, 'OK' AS code, 'Sessão encerrada' AS message;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2026-02-01  7:03:48
