export interface LedgerEventoSincronizacaoLocal {
  id_evento: string;
  id_tenant: number;
  id_sistema: number;
  id_unidade: number;
...
export interface LedgerEventoSincronizacaoLocalCreate {
  tipo_evento?: string;
  subtipo_evento?: string;
  payload_json?: Record<string, unknown>;
  origem_contexto?: string;
...
export interface LedgerEventoSincronizacaoLocalUpdate {
  tipo_evento?: string;
  subtipo_evento?: string;
  payload_json?: Record<string, unknown>;
  origem_contexto?: string;
