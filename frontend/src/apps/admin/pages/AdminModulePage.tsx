...
interface Acao {
    ...
    titulo: string;
    sp: string;
    params_obrigatorios?: string[];
    exemplo_payload?: Record<string, unknown>;
    sp_disponivel?: boolean;
}
...
export default function AdminModulePage() {
    ...
    const [catalogo, setCatalogo] = useState<Record<string, Acao[]>>({});
    ...
    const moduleData = useMemo(() => {
        const fallback = FALLBACK_MODULES[moduloId || "usuarios"] || FALLBACK_MODULES.usuarios;
