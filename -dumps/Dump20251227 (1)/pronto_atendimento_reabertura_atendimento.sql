...
CREATE TABLE `reabertura_atendimento` (
  ...
  CONSTRAINT `reabertura_atendimento_ibfk_1` FOREIGN KEY (`id_atendimento`) REFERENCES `atendimento` (`id_atendimento`),
  CONSTRAINT `reabertura_atendimento_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_reabertura_status` AFTER INSERT ON `reabertura_atendimento` FOR EACH ROW BEGIN
    UPDATE atendimento
...
-- Dump completed on 2025-12-27  2:29:39
