...
CREATE TABLE `internacao` (
  ...
  `status` enum('ATIVA','ENCERRADA') COLLATE utf8mb4_general_ci DEFAULT 'ATIVA',
  PRIMARY KEY (`id_internacao`),
  KEY `id_atendimento` (`id_atendimento`),
  KEY `id_leito` (`id_leito`),
  CONSTRAINT `internacao_ibfk_1` FOREIGN KEY (`id_atendimento`) REFERENCES `atendimento` (`id_atendimento`),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_leito_ocupado` BEFORE INSERT ON `internacao` FOR EACH ROW BEGIN
    IF EXISTS (
        SELECT 1 FROM leito
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_uma_internacao_ativa` BEFORE INSERT ON `internacao` FOR EACH ROW BEGIN
    IF EXISTS (
        SELECT 1 
        FROM internacao 
        WHERE id_atendimento = NEW.id_atendimento 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_encerrar_internacao` AFTER UPDATE ON `internacao` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_alta_internacao` AFTER UPDATE ON `internacao` FOR EACH ROW BEGIN
...
-- Dump completed on 2025-12-27  2:29:27
