...
CREATE TABLE `sala` (
  ...
  CONSTRAINT `sala_ibfk_1` FOREIGN KEY (`id_local`) REFERENCES `local_atendimento` (`id_local`),
  CONSTRAINT `sala_ibfk_2` FOREIGN KEY (`id_especialidade`) REFERENCES `especialidade` (`id_especialidade`)
...
-- Dump completed on 2025-12-27  2:29:31
