...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_admin_medicacao_duplicada` BEFORE INSERT ON `administracao_medicacao` FOR EACH ROW BEGIN
    IF EXISTS (
...
-- Dump completed on 2025-12-27  0:44:58
