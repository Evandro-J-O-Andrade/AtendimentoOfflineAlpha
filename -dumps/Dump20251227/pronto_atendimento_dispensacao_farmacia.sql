...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_baixa_estoque_dispensacao` AFTER INSERT ON `dispensacao_farmacia` FOR EACH ROW BEGIN
...
-- Dump completed on 2025-12-27  0:44:50
